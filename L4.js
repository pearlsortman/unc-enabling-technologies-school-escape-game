$(document).ready(function() {
    ...
    $('#scene').prepend('<img src="L4.jpeg"/>');
    $('#item_1').append('<p class="covering" id="equation">equation</p><p class="hidden tool" id="answer">answer</p>');
    $('#item_2').append('<p class="dummy" id="poster">math poster</p>');
    $('#item_3').append('<p class="tool" id="mathbook">mathbook</p>');
    $('#item_4').append('<p class="covering" id="safe">safe</p><p class="hidden tool" id="doorkey">doorkey</p>');
    $('#item_5').append('<p id="exit">door</p>');
